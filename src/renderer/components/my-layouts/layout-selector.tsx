  ...
  return (
    <div className="bg-accent h-full w-60 border-r-1">
      ...
      <ScrollArea className="h-full w-full shrink-0 grow p-2">
        <button className="hover:bg-accent-foreground/5 hover:border-accent-foreground/30 bg-card flex h-30 w-full flex-col items-center justify-center gap-1 rounded-xl border-2 transition-all hover:cursor-pointer hover:border-4">
