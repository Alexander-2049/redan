...
import { OverlayManifestStringSettingType } from '@/main/shared/schemas/overlay-manifest-file-schema';
import { OverlayManifestFile } from '@/shared/types/OverlayManifestFile';

interface StringSettingProps {
  setting: OverlayManifestStringSettingType;
  value: string;
  onSettingChange: (id: string, value: AcceptedValueTypes) => void;
  manifest: OverlayManifestFile;
}

export function StringSetting({ setting, value, onSettingChange }: StringSettingProps) {
