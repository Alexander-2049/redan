...
interface BasicSetupProps {
  ...
  setSettingsValues: (
    values: Record<string, any> | ((prev: Record<string, any>) => Record<string, any>),
  ) => void;
  overlayUrl: string;
}
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex gap-2">
            <Button
              ...
              variant={overlayState === 'open' || overlayState === 'edit' ? 'default' : 'outline'}
            >
              <Play className="mr-2 h-4 w-4" />
              Open Overlay
            </Button>
            <Button onClick={onCloseOverlay} disabled={overlayState === 'closed'} variant="outline">
          ...
          {overlayState !== 'closed' && (
            <div className="text-muted-foreground text-sm">
              ...
              <div className="bg-muted rounded p-2 font-mono text-xs break-all">{overlayUrl}</div>
            </div>
          )}
        </CardContent>
      </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-muted-foreground text-sm">
              Adjust settings for testing. Settings are only editable when overlay is closed.
            </p>
          </CardHeader>
          <CardContent className="space-y-4">
