...
export const ConfiguratorManifestConfig: React.FC<ManifestConfigProps> = ({
  ...
  const handleManifestFieldChange = (key: keyof OverlayManifest, value: any) => {
  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={e => handleManifestFieldChange('title', e.target.value)}
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={e => handleManifestFieldChange('description', e.target.value)}
      ...
      <ConfiguratorNestedBoxes
        ...
        onMinWidthChange={value => handleManifestFieldChange('minWidth', value)}
        onMinHeightChange={value => handleManifestFieldChange('minHeight', value)}
        onDefaultWidthChange={value => handleManifestFieldChange('defaultWidth', value)}
        onDefaultHeightChange={value => handleManifestFieldChange('defaultHeight', value)}
        onMaxWidthChange={value => handleManifestFieldChange('maxWidth', value)}
        onMaxHeightChange={value => handleManifestFieldChange('maxHeight', value)}
      />
    </div>
  );
};
