...
const assettoCorsaClient = new AssettoCorsaSDK();

assettoCorsaClient.addListener("open", (game) => {
  console.log(game);
});

const iracingClient = IRacingSDK.init();
iracingClient.addListener("Telemetry", (data: TelemetryEvent) => {
  console.log("Telemetry received", data.data.Throttle);
});
