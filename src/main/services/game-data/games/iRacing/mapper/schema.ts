import { z } from "zod";
import { GameNameSchema } from "../../../types/game-name-schema";
import { WetnessSchema } from "../../../types/game-data-schema";

const minimalRealtime = z.object({
  throttle: z.number(),
  brake: z.number(),
